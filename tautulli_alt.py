...
class Tautulli:
    """Tautulli base class"""
    def __init__(self, host=None, port=None, apikey=None, schema=None,
                 path=None):
        self.host = host
        self.port = port
        self.apikey = apikey
    ...
    @staticmethod
    def get_history(grouping=None, user=None, user_id=None, rating_key=None,
                    parent_rating_key=None, grandparent_rating_key=None,
                    start_date=None, section_id=None, media_type=None,
    ...
    @staticmethod
    def get_activity(session_key=None, session_id=None, out_type=None,
                     callback=None, debug=None):
        """
        ...
        payload = Payload('get_activity', out_type=out_type, callback=callback,
                          debug=debug, session_key=session_key,
    ...
    @staticmethod
    def get_apikey(username=None, password=None, out_type=None, callback=None,
                   debug=None):
        """
        Get the apikey.
        ...
        payload = Payload('get_apikey', out_type=out_type, callback=callback,
